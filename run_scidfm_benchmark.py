...
# ///
"""Benchmark runner for OpenDFM/SciDFM-MoE-A5.6B-v1.0 on physics datasets.
Run with: uv run --python 3.11 run_scidfm_benchmark.py -b <benchmark>
"""
...
os.environ.setdefault("CUDA_VISIBLE_DEVICES", "0,1,2")  # must precede torch import
...
if __name__ == "__main__":
    ...
    parser.add_argument("--temperature", type=float, default=0.0, help="0.0 = greedy decoding (recommended for MCQ)")
