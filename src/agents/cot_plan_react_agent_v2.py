...
from src.agents.utils.tools import retrieve_physics_theory, retriever_backend
from src.utils.helpers import load_yaml

agent_cfg = load_yaml("config/cot_plan_react_agent_v2.yaml")
...
class COTPhysicsAgent:
    ...
    def _execute(self, state: State) -> State:
        ...
        state["messages"] = [
            HumanMessage(
                content=agent_cfg["executor_prompt"].format(
